  ...
  <div className="flex justify-center flex-col items-center h-full" style={{ background: `url("/assets/Group6.png") #070724`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
          <div className="flex justify-center items-center mt-[50px]">
              <div className="flex flex-col items-center justify-center mt-[100px] w-[256px] h-[256px]">
                  <img src="/assets/uranus1.svg" alt="Mercury" className="w-[256px] h-[256px] mt-[-235px] z-0 ml-[30px]" />
              </div>
              ...
              <div className="flex flex-col justify-center items-center ml-[350px] mt-[-250px]">
                  ...
                  <p className="text-white w-[333px] h-[104px] ml-[70px] opacity-40">Uranus is the seventh planet from the Sun. Its name is a reference to the Greek god of the sky, Uranus according to Greek mythology, was the great-grandfather of Ares. It has the third-largest planetary radius and fourth-largest planetary mass in the Solar System.</p>
              ...
              <div className="w-[350px] h-[176px] mt-[300px] ml-[-330px]">
               <button className="w-[350px] h-[48px] bg-none mt-[20px] text-white bg-[#1EC1A2;]">OVERVIEW</button>
