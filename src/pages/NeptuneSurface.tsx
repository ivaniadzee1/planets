                ...
                <div className="flex justify-center flex-col items-center h-full" style={{ background: `url("/assets/Group6.png") #070724`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                    <div className="flex justify-center items-center mt-[50px]">
                        <div className="flex flex-col items-center justify-center mt-[100px] w-[256px] h-[256px]">
                            <img src="/assets/neptune1.svg" alt="Mercury" className="w-[256px] h-[256px] mt-[-80px] z-0 ml-[30px]" />
                            <img className="z-10 mt-[-50px] ml-[35px]" src="/assets/neptune4.svg" alt="" />
                        </div>
                        ...
                        <div className="w-[350px] h-[176px] mt-[300px] ml-[-330px]">
                            <Link to="/neptune"> <button className="w-[350px] h-[48px] bg-none text-white border-2  border-gray-500 hover:bg-gray-600">OVERVIEW</button></Link>
                            ...
                            <button className="w-[350px] h-[48px] bg-none mt-[20px] text-white  bg-[#2D68F0;]">SURFACE GEOLOGY</button>
                        </div>
                    </div>
